    ...
    <div className="share">
        <div className="shareWrapper">
            <div className="shareTop">
                ...
                <input placeholder={"Share Your Fleeting Thoughts "+user.username} className="shareInput" 
                ref={desc}/>
            </div>
            ...
            <form className="shareBottom" onSubmit={submitHandler}>
                <div className="shareOptions">
                    <label htmlFor="file" className="shareOption">
                        ...
                        <span className="shareOptionText">Tag</span> </div>
                        <div className="shareOption">
                        <LocationOn htmlColor="green" className="shareIcon"/>
                        <span className="shareOptionText"> Location</span> </div>
                        <div className="shareOption">
                        <Mood htmlColor="#7a4f0d" className="shareIcon"/>
                        <span className="shareOptionText"> Feelings</span> </div>
